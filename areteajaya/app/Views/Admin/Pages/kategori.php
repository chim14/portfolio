                                ...
                                <tr>
                                    ...
                                    <td width="15%" class="text-center">
                                        <div class="d-flex justify-content-center align-items-center">
                                            <!-- Edit Button -->
                                            <button type="button" class="btn btn-success btn-sm me-1" data-bs-toggle="modal" data-bs-target="#ubahModal<?= $kategori->idKategori; ?>">
        ...
        <div class="modal fade" id="ubahModal<?= $kategori->idKategori; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?= base_url('kategori/ubah/' . $kategori->idKategori) ?>" method="post">
                            <?= csrf_field() ?>
        ...
        <div class="modal fade" id="hapusModal<?= $kategori->idKategori; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?= base_url('kategori/hapus/' . $kategori->idKategori) ?>" method="post">
                            <?= csrf_field() ?>
